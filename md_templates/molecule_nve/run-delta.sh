...
echo "starting..."
i-pi -S $socketdir input-mol-delta.xml | tee ipi.out &
echo "started i-pi"
sleep 2
echo "starting driver..."
i-pi-py_driver -S $socketdir -u -m pet -a driver -o "../model,init-mol.xyz,device=cuda,checkpoint=model" | tee calc.out &
